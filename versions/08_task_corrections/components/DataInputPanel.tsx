...
export function DataInputPanel() {
  ...
  return (
    <div className="grid gap-5">
      <section className="rounded-lg border border-sky/15 bg-white p-5 shadow-soft">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-saffron">
              Готово к проверке
            </p>
            <h1 className="mt-2 text-2xl font-semibold text-sky sm:text-3xl">
        ...
        <div
          {...getRootProps({
            ...
            className: [
              ...
              isDragActive
                ? "border-saffron bg-[#f2f5ff]"
                : "border-sky/18 bg-white hover:border-saffron hover:bg-[#f7f9ff]",
        ...
        >
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex max-w-3xl gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-sky">
          ...
          <label
            ...
            className="mt-5 flex items-center gap-2 text-base font-semibold text-sky"
          >
